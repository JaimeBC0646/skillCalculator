...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenido a la calculadora, hola JB';
...
const MultiplicaIntent = {
    ...
    handle(handlerInput) {
        ...
        const resultado = numero1 * numero2;
        const speakOutput = `El resultado de la multiplicacion de ${numero1} por ${numero2} es igual a ${resultado}.`;
...
const RaizCuadradaIntent = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `El resultado de la raiz cuadrada de ${numero1} es ${resultado}.`;
...
const ExponenteIntent = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'ExponenteIntent';
    },
    handle(handlerInput) {
        const cantidad1 = handlerInput.requestEnvelope.request.intent.slots.uno.value;
        const cantidad2 = handlerInput.requestEnvelope.request.intent.slots.dos.value;
        const base = Number(cantidad1);
        const exponente = Number(cantidad2);
        ...
        const speakOutput = `El resultado de elevar ${base} a ${exponente} es ${resultado}.`;
